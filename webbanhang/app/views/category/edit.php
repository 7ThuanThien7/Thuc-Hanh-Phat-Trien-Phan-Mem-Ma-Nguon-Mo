...
<form method="POST" action="/Category/update" enctype="multipart/form-data" onsubmit="return validateForm();">
...
<a href="/Category" class="btn btn-secondary mt-2">Quay lại danh sách sản phẩm</a>
